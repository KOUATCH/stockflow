...
console.log({res})
      ...
      toast.success("Email account verified successfully!",{ description:"Account successfully verified"});
      setLoading(false);
      setSuccess(true);
      router.push("/Login")
    } catch (error) {
      ...
      toast.error(" something went wrong and account not verified", {description:" There was an error verifying your code. Please try again. "});
    }
  };
          ...
          {success ? (
            ...
            <div className="">
              <div className="grid gap-2 mt-10 md:mt-0">
                ...
                <h1 className="text-3xl font-bold">A 6-digit otp verification code {userId} has been sent to your email account  {email}</h1>
