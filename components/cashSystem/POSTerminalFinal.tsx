...
const getCategoryIcon = (categoryName: string) => {
  ...
  ) as keyof typeof CATEGORY_ICONS | undefined
...
const MOCK_TERMINALS = {
  ...
  "loc-3": [
    { id: "term-6", name: "Downtown Terminal 1", status: "active" },
  ],
}
...
export function POSTerminalFinal({ organizationId, locationId, terminalId, userId }: pOSStationProps): ReactElement {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-6 space-y-6 transition-colors duration-300 ${isDarkMode ? "dark" : ""}`}>
      {/* Header Section */}
      ...
      <div className="flex items-center justify-between bg-red-700/10 p-4 rounded-lg shadow-md">
        <div>
          ...
          <p className="text-muted-foreground text-lg mt-1">Process sales and manage transactions Cash system Terminal Final POSTF</p>
          {currentSession && (
            <div className="flex items-center gap-4 mt-3">
              <Badge variant="outline" className="flex items-center gap-2 px-3 py-1">
                <CheckCircle className="h-4 w-4 text-green-500" />
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 p-4">
                      ...
                      >
                        ...
                        >
                          <div className={`p-1 rounded-lg border-2 transition-all duration-300 ${selectedCategory === "all"
                            ...
                            <div className="flex flex-col items-center text-center">
                              <div className={`p-3 rounded-full mb-3 ${selectedCategory === "all"
                                ? "bg-white/20"
                                : "bg-gradient-to-br from-blue-500 to-blue-600"
                                }`}>
                                <Grid3X3 className={`h-4 w-4 ${selectedCategory === "all" ? "text-white" : "text-white"
                                  }`} />
                              </div>
                              <h3 className={`font-semibold text-sm mb-2 ${selectedCategory === "all" ? "text-white" : "text-gray-800"
                                }`}>
                                All Items
                              </h3>
                              <Badge variant={selectedCategory === "all" ? "secondary" : "outline"} className="bg-white/20 text-xs">
                        ...
                        {categoriesArray.map((category) => {
                          ...
                          return (
                            ...
                            >
                              <div className={`p-2 rounded-xl border-2 transition-all duration-300 ${isSelected
                                ...
                                <div className="flex flex-col items-center text-center">
                                  <div className={`p-3 rounded-full mb-3 ${isSelected
                                    ? "bg-white/20"
                        ...
                        >
                          <div className={`p-3 rounded-xl border-2 transition-all duration-300 ${selectedCategory === "favorites"
                            ...
                            <div className="flex flex-col items-center text-center">
                              <div className={`p-3 rounded-full mb-3 ${selectedCategory === "favorites"
                                ? "bg-white/20"
                                : "bg-gradient-to-br from-yellow-500 to-orange-500"
                                }`}>
                                <Star className={`h-4 w-4 ${selectedCategory === "favorites" ? "text-white" : "text-white"
                                  }`} />
                              </div>
                              <h3 className={`font-semibold text-sm mb-2 ${selectedCategory === "favorites" ? "text-white" : "text-gray-800"
                                }`}>
                                Favorites
                              </h3>
                              <Badge variant={selectedCategory === "favorites" ? "secondary" : "outline"} className="bg-white/20 text-xs">
                        ...
                        >
                          <div className={`p-3 rounded-xl border-2 transition-all duration-300 ${selectedCategory === "recent"
                            ...
                            <div className="flex flex-col items-center text-center">
                              <div className={`p-3 rounded-full mb-3 ${selectedCategory === "recent"
                                ? "bg-white/20"
                                : "bg-gradient-to-br from-purple-500 to-purple-600"
                                }`}>
                                <Clock className={`h-4 w-4 ${selectedCategory === "recent" ? "text-white" : "text-white"
                                  }`} />
                              </div>
                              <h3 className={`font-semibold text-sm mb-2 ${selectedCategory === "recent" ? "text-white" : "text-gray-800"
                                }`}>
                                Recent
                              </h3>
                              <Badge variant={selectedCategory === "recent" ? "secondary" : "outline"} className="bg-white/20 text-xs">
                        ...
                        if (cat) {
                          ...
                          return (
                            <>
                              ...
                              <Badge variant="secondary" className="bg-blue-100 text-blue-800">{filteredItems?.length || 0} items</Badge>
                            </>
                          )
                        }
                        return null
                    ...
                    {filteredItems && filteredItems.length > 0 ? (
                      filteredItems.map((item) => {
                        ...
                        return (
                          <div
                            key={item.id}
                            className={`group relative flex flex-col p-4 rounded-xl border-2 hover:shadow-xl cursor-pointer transition-all duration-300 hover:scale-105 bg-white/80 backdrop-blur-sm ${isLowStock
                          ...
                          >
                            ...
                            <div className="flex-1 mb-4">
                              ...
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                {isLowStock && (
                                  <Badge variant="outline" className="text-xs px-2 py-0 text-orange-600 border-orange-300 bg-orange-50">
                                    Low
                                  </Badge>
                                )}
                              </div>
                              <Progress
                                value={Math.min((stockLevel / 20) * 100, 100)}
                                className="h-2 mb-3"
                              />
                            </div>
            ...
            {cart.length > 0 && (
              <div className="space-y-3 max-w-md mx-auto">
                ...
                {cart.slice(-3).map((item) => (
                  <div key={item.id} className="flex justify-between items-center text-base bg-white/10 backdrop-blur-sm rounded-lg p-3">
      ...
      <Dialog open={isPaymentDialogOpen} onOpenChange={setIsPaymentDialogOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Complete the transaction for <span className="font-bold text-emerald-600">{formatCurrency(calculateTotal())}</span>
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <Button
                  ...
                  className={`flex items-center gap-2 h-16 ${paymentMethod === PaymentMethod.CARD
            ...
            {paymentMethod === PaymentMethod.CASH && (
              <div className="space-y-3">
                <Label htmlFor="cashTendered" className="text-base font-semibold">Cash Tendered</Label>
                <Input
                  id="cashTendered"
                  type="number"
                  step="0.01"
...
export default POSTerminalFinal


// export default pOSStationdLocationId} onValueChange = { setSelectedLocationId } >
