...
import { useCreatePosStation, useLocationsByOrganization, useOrganizations } from "@/hooks/posStation/use-pos-stations"
import { posStationSchema, type CreatePosStationInput } from "@/lib/validations/pos-station"
...
export function PosStationForm() {
  ...
  const handleOrganizationChange = (organizationId: string) => {
    ...
    form.setValue("locationId", "") // Reset location when organization changes
  }
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={handleOrganizationChange} value={field.value} disabled={organizationsLoading}>
                    <FormControl>
                      <SelectTrigger>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select
                    ...
                    value={field.value}
                    disabled={!selectedOrganizationId || locationsLoading}
                  >
                    <FormControl>
                      <SelectTrigger>
                  ...
                  <FormDescription>
                    {!selectedOrganizationId && "Select an organization first"}
