...
import { cashDrawerTransaction } from "@/lib/newPOSSession/db"
import type { cashDrawerTransactionType } from "@/types/newPOSSession/types"
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-600">{formatDateTime(event.createdAt)}</div>
