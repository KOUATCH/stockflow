...
import type { Alert } from "@/hooks/newPOSSession/use-real-time-tracking"
import {
  useLowStockMonitoring,
  useRealTimeBalanceTracking,
  useSessionTimeoutMonitoring,
} from "@/hooks/newPOSSession/use-real-time-tracking"
...
export function AlertCenter({ terminalId, sessionId, locationId, organizationId }: AlertCenterProps) {
  ...
  // const { sessionDurationHours, isApproachingTimeout, selectedTerminal } = useSessionTimeoutMonitoring()
      ...
      <Dialog open={!!selectedAlert} onOpenChange={() => setSelectedAlert(null)}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedAlert && format(selectedAlert.timestamp, "MMM dd, yyyy HH:mm:ss")}
            </DialogDescription>
          </DialogHeader>
