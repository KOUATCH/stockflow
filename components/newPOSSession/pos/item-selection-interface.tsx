      ...
      <ScrollArea className="w-full whitespace-nowrap">
        <div className="flex gap-3 pb-2">
          ...
          {categoryData?.map((category) => {
            ...
            const categoryItemCount = items?.filter((item) => item?.category?.id === category.id).length || 0
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 mb-3">
                <div className="font-medium text-card-foreground text-sm leading-tight mb-1">{item.name}</div>
