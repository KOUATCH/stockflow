...
import { type Column, ConfirmationDialog, DataTable, EntityForm2, TableActions } from "@/components/ui/data-table"
...
const UnifiedSupplierFormRevised = ({
  title,
  organizationId,
  editingId,
  initialSupplierData,
    ...
    try {
      ...
      await updateSupplierMutation.mutateAsync(updatedSupplier, {
        onSuccess: async () => {
          ...
          setSupplierToEdit(updatedSupplier)
          await refetch()
        },
        onError: (error: any) => {
  ...
  return (
    <>
      ...
      <EntityForm2
        ...
        form={form}
        size="xl"
        // Now we can safely pass undefined when in edit mode
        ...
        hideSubmitButton={isEditMode} // Use this instead of the previous logic
      >
...
export default UnifiedSupplierFormRevised