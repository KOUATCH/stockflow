...
export const ItemForm = ({ form, itemImageUrl, setItemImageUrl, organizationId }: ItemFormProps) => {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Enter item name" {...field} className="transition-colors" />
                  </FormControl>
