...
const MODEL_EXCEL_PATHS = {
  ...
  brand: "/Brands.xlsx",
  warehouse: "/Warehouses.xlsx",
  supplier: "/Suppliers.xlsx",
  unit: "/Units.xlsx",
  product: "/Products.xlsx",
};

type ModelType = keyof typeof MODEL_EXCEL_PATHS;
...
type TableHeaderProps = {
  ...
  data: any;
  model: ModelType;
  // Process data function now passed as a prop
  processData?: (json: any[]) => Promise<any>;
  showImport?: boolean;
};

export default function TableHeaderRefactored({
  title,
  href,
  linkTitle,
  data,
  ...
  // Get the excel download path from the model configuration
  const excelDownload = MODEL_EXCEL_PATHS[model] || "#";
      ...
      reader.onload = async (e) => {
        ...
        if (data) {
          ...
          try {
            ...
            // Use the processData function passed as prop if available
            if (processData) {
