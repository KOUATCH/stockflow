...
import type { ItemPerformanceReport } from "@/lib/analytics/financial-reports"
...
export function ItemPerformanceReportComponent({ reports }: ItemPerformanceReportProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold">Item Performance Report</h2>
          <p className="text-muted-foreground">{reports.length} items analyzed</p>
        </div>
      </div>
