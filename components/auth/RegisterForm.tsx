                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <Badge
                        variant="outline"
                        className="flex items-center gap-1 px-2 py-1 text-xs bg-white/80 backdrop-blur-sm"
                      >
          ...
          <div className="mb-6">
            <div className="relative mb-4">
              ...
              <div className="relative">
                ...
                <div
                  className="absolute top-0 left-0 h-2 rounded-full bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 transition-all duration-1000 ease-out"
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isActive &&
                      `border-transparent bg-gradient-to-br ${step.bgGradient} shadow-xl scale-105 -translate-y-1`,
                      isCompleted &&
                      !isActive &&
                      "border-emerald-300 bg-gradient-to-br from-emerald-50 to-green-50 dark:bg-emerald-950/50 shadow-md",
                      !isActive &&
                      !isCompleted &&
                      isAccessible &&
                      "border-slate-200 dark:border-slate-700 hover:border-emerald-300 bg-white/80 dark:bg-slate-800/80",
                      !isAccessible &&
                      !isCompleted &&
                      "border-slate-100 dark:border-slate-800 opacity-50 cursor-not-allowed bg-white/50",
                    )}
                  >
                    {isActive && (
                      <div
                      ...
                      <div className="flex items-center gap-3 mb-3">
                        <div
                          className={cn(
                            ...
                            !isActive &&
                            !isCompleted &&
                            "bg-slate-100 dark:bg-slate-800 text-slate-400 group-hover:bg-emerald-100",
                          )}
                        >
                          {isCompleted ? (
                        ...
                        <div>
                          <h3
                            className={cn(
                              ...
                              !isActive &&
                              !isCompleted &&
                              "text-slate-700 dark:text-slate-300 group-hover:text-emerald-700",
                            )}
                          >
                            {step.title}
                          </h3>
                        ...
                        <div className="flex items-center gap-3 mb-6">
                          ...
                          <div>
                            ...
                            <p className="text-slate-600 dark:text-slate-400 text-sm">
                              Create a secure password and accept terms
                            </p>
                          </div>
                        </div>
                    ...
                    <div className="flex gap-2">
                      {currentStep !== "personal" && (
                        <Button
                          ...
                          className="flex-1 h-10 border-2 hover:scale-105 transition-all duration-300 bg-transparent"
