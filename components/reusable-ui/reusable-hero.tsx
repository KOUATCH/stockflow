...
const ReUsableHero: React.FC<HeroProps> = ({
  ...
  const backgroundStyles = {
    ...
    blue: {
      ...
      gradient: "from-cyan-400 via-blue-400 to-rose-400",
      blur: ["bg-blue-500/30", "bg-cyan-500/20", "bg-rose-500/20"],
      floating:
        theme === "light"
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 pt-10 md:pt-12  sm:px-6 lg:px-8">
        ...
        <div className="relative text-center max-w-4xl mx-auto mb-20">
          ...
          {/* Main content */}
          <h1
            className={`text-3xl md:text-4xl lg:text-4xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r ${style.gradient} hidden md:block`}
          >
            {title}
          </h1>
          <h1
            className={`text-3xl md:text-4xl lg:text-4xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r ${style.gradient} md:hidden px-2`}
          >
            {mobileTitle || title}
          </h1>
          <p
            className={`text-xl ${currentTheme.base.subtitleText} max-w-4xl mx-auto mb-8`}
          >
            {subtitle}
          </p>
            ...
            <div className="pt-8 pb-4 flex items-center  justify-center gap-8">
              ...
              <div className="">
                ...
                <p className="dark:text-slate-900">
                  {userCount} Enterprises are Enjoying it now.
                </p>
              </div>
            </div>
          )}
