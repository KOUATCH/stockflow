      ...
      <div className="relative">
        ...
        <div className="max-w-7xl mx-auto mb-16 flex flex-col md:flex-row justify-between items-start md:items-center">
          <div className="mb-8 md:mb-0">
            ...
            Efficient and effortless Inventory
            </h2>
            <p className="text-gray-400 max-w-xl text-base">
             You will wonder why you ever managerd without this sofware. You will never try to do any business without using this stock management tool
            </p>
          </div>
