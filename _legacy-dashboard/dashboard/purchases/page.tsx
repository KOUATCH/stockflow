              ...
              <table className="w-full">
                  ...
                  {computedLines.length > 0 ? (
                    computedLines.map((line, idx) => (
                      <tr key={line.id} className={idx % 2 === 0 ? "bg-gray-50/50" : ""}>
                        ...
                        <td className="py-3 px-4 text-right font-medium">{line.qty}</td>
                        <td className="py-3 px-4 text-right">{formatCurrency(line.unitCost)}</td>
                        <td className="py-3 px-4 text-right font-medium">{formatCurrency(line.lineTotal)}</td>
                      </tr>
                    ))
                  ) : (
                    <tr>
                ...
                <tfoot>
                  <tr className="border-t-2 font-bold">
                    ...
                    <td className="py-3 px-4 text-right text-lg">{formatCurrency(total)}</td>
                  </tr>
                </tfoot>
              </table>
            </div>
