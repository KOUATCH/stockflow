...
export function usePurchaseOrderWorkflow(id: string, organizationId?: string, currentUserId?: string) {
  ...
  const receiveMutation = useMutation({
    mutationFn: async (lines: { lineId: string; quantity: number }[]) => {
      ...
      const payload = {
        ...
        receivedBy: currentUserId, // This should come from auth context
