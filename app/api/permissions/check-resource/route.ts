/**
 * API Route: /api/permissions/check-resource
 *
 * Handles resource-level permission checks for authenticated users.
 */
...
export async function POST(req: NextRequest) {
  try {
    ...
    const result = await permissionManager.canAccessResource(
      user as any,
      resourceType,
      resourceId,
      action,
    ...
    console.error('Resource permission check API error:', error);
    return NextResponse.json(
      {
